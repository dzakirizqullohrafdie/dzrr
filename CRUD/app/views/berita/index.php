...
<head>
  ...
  <link rel="stylesheet" href="/Dzrr/crud/public/assets/css/bootstrap.min.css">
  <link rel="stylesheet" href="/Dzrr/crud/public/assets/vendors/bootstrap-icons/bootstrap-icons.css">
  <link rel="stylesheet" href="/Dzrr/crud/public/assets/css/style.css">
</head>
          ...
          <section class="panel">
            <div class="panel-header">
              <div>
                ...
                <a href="?aksi=tambah" class="btn btn-sm btn-primary mt-3">Tambah</a>
              </div><input class="form-control form-control-sm table-search" type="search" placeholder="Search orders"
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($berita)) {
                    ...
                    <tr>
                      ...
                      <td><?= $row['tanggal']; ?></td>
                      <td>
                        <a href="?aksi=edit&id=<?= $row['id']; ?>" class="btn btn-warning btn-sm">
